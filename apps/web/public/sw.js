...
const SHELL = ['/', '/index.html', '/styles.css', '/manifest.webmanifest', '/favicon.svg', '/icons/icon-192.png', '/icons/icon-512.png',
  '/js/app.js', '/js/api.js', '/js/ui.js', '/js/pages-public.js', '/js/pages-app.js', '/js/pages-remix.js', '/js/pages-library.js', '/js/pages-seo.js', '/js/pages-admin.js', '/js/pages-workspace.js', '/js/player.js', '/js/transcript.js', '/js/tts.js', '/js/shortcuts.js', '/js/autosave.js', '/js/stt-worker.js', '/js/render-browser.js'];
